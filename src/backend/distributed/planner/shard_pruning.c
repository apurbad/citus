...
static ClauseWalkerContext * BuildClauseWalkerContext(Var *column, List *whereClauseList,
			...
			Const **partitionValueConst)
{
	...
	List *pruningInstanceList = GeneratePruningInstanceList(partitionColumn,
															whereClauseList,
															&compareValueFunctionCall);
...
List *
GeneratePruningInstanceList(Var *column, List *whereClauseList,
							FunctionCall2InfoData *compareValueFunctionCall)
{
	...
	ClauseWalkerContext *clauseWalkerContext =
		BuildClauseWalkerContext(column, whereClauseList, compareValueFunctionCall);
...
BuildClauseWalkerContext(Var *column, List *whereClauseList,
						 FunctionCall2InfoData *compareValueFunctionCall)
{
